...
import com.yilos.secretary.bean.ContactsResult;
...
import com.yilos.secretary.common.LosSSLFactory;
...
public class ApiClient 
{
	...
	public static ServerMemberResponse checkUserAccount(Context appContext,String mobileNumber)
	{
		...
		//String json = _httpget(appContext, MessageFormat.format(Constants.CHECK_VALIDATECODE_SERVICE, mobileNumber));
		Gson gson = new Gson();
	...
	{
		//改为一次拉取所有 去除report参数
		//String json = _httpget(MessageFormat.format(Constants.SYNCREPORTS_URL, shopid,year,month,day,type));
