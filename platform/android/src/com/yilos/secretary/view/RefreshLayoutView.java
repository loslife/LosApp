...
import com.yilos.secretary.view.RefreshableView.HideHeaderTask;
import com.yilos.secretary.view.RefreshableView.PullToRefreshListener;
import com.yilos.secretary.view.RefreshableView.RefreshingTask;

public class RefreshLayoutView extends LinearLayout implements OnTouchListener {  
    ...
    public RefreshLayoutView(Context context, AttributeSet attrs) {  
        ...
        pullrefresh =  (LinearLayout) header.findViewById(R.id.pullrefresh);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {  
        ...
        if (changed && !loadOnce) {  
            ...
            layout = (LinearLayout) getChildAt(1);  
    ...
    private void setIsAbleToPull(MotionEvent event) {  
        ...
        if (firstChild != null) {  
            int firstVisiblePos = layout.getScrollY();  
