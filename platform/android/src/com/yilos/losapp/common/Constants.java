...
public class Constants 
{
	 ...
	 * 获取验证码
	 */
	public static final String SEND_VALIDATECODE = "http://192.168.1.108:5000/svc/getCode/{0}?u={1}";
	
	/**
	 * 检查验证码
	 */
	public static final String CHECK_VALIDATECODE_SERVICE = "http://192.168.1.108:5000/svc/checkCode/{0}?u={1}&c={2}";
	
	/**
	 * 检查店铺的账号
	 */
	public static final String CHECHSHOPUSER_SERVICE = "http://192.168.1.108:5000/svc/"
			+ "oauth/login/checkUser?username=";
	
	/**
	 * 注册
	 */
	public static final String REGISTER_URL = "http://" + "192.168.1.108:5000"
			+ "/svc/losapp/register";
	
	/**
	 * 登录
	 */
	public static final String LOGIN_URL ="http://" + "192.168.1.108:5000"
			+ "/svc/losapp/login";
	 ...
	 * 获取会员通讯录
	 */
	public static final String GET_MEMBERS_URL = "http://" + "192.168.1.108:5000"
			+ "/svc/"
	 ...
	 * 获取会员的数量
	 */
	public static final String GET_MEMBERS_COUNT = "http://192.168.1.108:5000/svc/losapp/countMembers/{0}";
	
	/**
	 * 查询已关联的店铺
	 */
	public static final String GET_APPENDSHOP_RECORD = "http://192.168.1.108:5000/svc/losapp/attachEnterprises/{0}";
	
	/**
	 * 关联店铺
	 */
	public static final String APPENDSHOP_URL = "http://192.168.1.108:5000/svc/losapp/appendEnterprise";
	
	/**
	 * 取消关联
	 */
	public static final String UNDOAPPENDSHOP_URL = "http://192.168.1.108:5000/svc/losapp/undoAppendEnterprise";
	
	/**
	 * 
	 */
	public static final String CHECKNEWVERSION_URL = "http://192.168.1.108:5000/svc/losapp/checkNewVersion/{0}";

	
	/**
	 * 同步经营数据
	 */
	public static final String SYNCREPORTS_URL = "http://192.168.1.108:5000/svc/report/probe/query/{0}?year={1}&month={2}&day={3}&type={4}&report={5}";
